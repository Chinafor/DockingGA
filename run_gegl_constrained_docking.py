...
from util.docking.cal_dockingscore import cal_docking
import neptune
...
if __name__ == "__main__":
    ...
    parser.add_argument("--smi_id_min", type=int, default=421)#902
    parser.add_argument("--smi_id_max", type=int, default=774)#old 800
    parser.add_argument("--dataset", type=str, default="zinc")
    #parser.add_argument("--dataset_path", type=str, default="./resource/data/zinc/logp_800.txt")
    parser.add_argument("--dataset_path", type=str, default="./resource/data/zinc/7vih_774.txt")

    parser.add_argument("--max_smiles_length", type=int, default=120)
    parser.add_argument("--similarity_threshold", type=float, default=0.6)#0.4/0.6 两次实验
    parser.add_argument("--apprentice_load_dir", type=str, default="./resource/checkpoint/zinc_selfies_trans_new11.4")
    ...
    parser.add_argument("--num_steps", type=int, default=50)#50
    ...
    neptune.init(project_qualified_name="raymond/gegl",
                 api_token='eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiJlMGVhNGY2MC1kNzM0LTQwMzEtODFlNS03YTkzYThlYmJiOWUifQ==',
                 )
    ...
    for smi_id in range(args.smi_id_min, args.smi_id_max):
        ...
        #docking
        reference_dscore = cal_docking(reference_smi)
        optimized_dscore = cal_docking(optimized_smi)
