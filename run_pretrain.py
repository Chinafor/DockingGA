...
if __name__ == "__main__":
    ...
    # Training parameters
    parser.add_argument("--learning_rate", type=float, default=1e-3)#1e-2-3-4
    parser.add_argument("--num_epochs", type=int, default=20)#10
    parser.add_argument("--batch_size", type=int, default=256)

    # Directory to save the pretrained model
    parser.add_argument("--save_dir", default="./resource/checkpoint/zinc_selfies_trans_test1117/")
